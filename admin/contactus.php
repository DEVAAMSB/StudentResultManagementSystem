      ...
      <div class="main-content-header">
        <form method='post'>
          <table class="table">
              ...
              <tr>
              <td><input type='text' class='tbldata' name='name' placeholder='Enter Your Name' Required/></td>
              </tr>
              <tr>
                <th class='tblheading'>Email</th>
              </tr>
              <tr>
                <td class='tbldata'><input type='text' class='tbldata' name='email' placeholder='Enter your Email' Required/></td>
              </tr>
              <tr>
                <th class='tblheading'>Phone</th>
              </tr>
              <tr>
                <td class='tbldata'><input type='text' class='tbldata' name='cont' placeholder='Enter your Phone Number' Required/></td>
              </tr>
              <tr>
