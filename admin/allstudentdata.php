        ...
        <form>
         <table>
          <tr>
           ...
           <th class="contact_h1">Branch Name</th>
           <th class="massage_h1">Data</th>
  ...
  if(mysqli_num_rows($run)>0)
{
     while($row=mysqli_fetch_assoc($run))
     {
        ...
        <tr>
            ...
            <th class="contact_h"> <?php  echo $row['u_branch'].'<br>'; ?></th>
            <th class="contact_h"> <?php  echo $row['u_data'].'<br>'; ?></th>
