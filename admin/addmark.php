            ...
            <table class="table1">
             ...
             <tr>
                <th>father Name </th>   <th> Mother Name</th> <th>Mobile No</th><th>Your City</th>
                 ...
                 <tr>
                 <td><input type='text' name='branch' placeholder="branch's Name" required class="box"/></td>
                 <td><input type='text' name='data' placeholder="data born" required class="box"/></td>
